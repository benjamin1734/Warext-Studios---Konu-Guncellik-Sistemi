...
**Hazır ZIP:** `XenForo-ACP-Direct-Install-Warext-Konu-Guncellik-1.0.2.zip`

**Tek tık indirme:** https://github.com/benjamin1734/Warext-Studios---Konu-Guncellik-Sistemi/releases/download/v1.0.2/XenForo-ACP-Direct-Install-Warext-Konu-Guncellik-1.0.2.zip
...
`XenForo-ACP-Direct-Install-Warext-Konu-Guncellik-1.0.2.zip` paketini XenForo yönetim panelindeki arşivden eklenti kurma/yükseltme ekranından yükleyin.
...
Bu paket resmi **1.0.2 Stable** sürümüdür. Denetim sırasında kullanılan dahili XenForo `version_id` değeri geriye çekilmemiştir; bu sayede daha önce test paketini kurmuş sistemlerde sürüm düşürme riski oluşturulmaz.
